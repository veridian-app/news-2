                                    ...
                                    <>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <button
                                                ...
                                                className="w-full h-12 bg-white hover:bg-zinc-100 rounded-xl flex items-center justify-center gap-3 transition-all active:scale-[0.98]"
                                            >
                                            ...
                                            <div className="relative py-2">
                                                ...
                                                <div className="relative flex justify-center">
                                                    <span className="bg-zinc-900 px-4 text-[8px] font-bold uppercase tracking-widest text-white/20">O con email</span>
                                                </div>
                                            </div>
